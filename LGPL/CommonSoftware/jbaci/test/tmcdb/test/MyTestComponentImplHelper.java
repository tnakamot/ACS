...
import alma.TMCDB.MyTestComponentPOATie;
 ...
 */
public class MyTestComponentImplHelper extends ComponentHelper
{
	/**
	 * Passes a logger to the callback object.
	 * @param containerLogger
	 */
	public MyTestComponentImplHelper(Logger containerLogger)
	{
	...
	{
		return new MyTestComponentImpl();
	}
	...
	{
		return MyTestComponentPOATie.class;
	}
	...
	{
		return MyTestComponentOperations.class;
	}
