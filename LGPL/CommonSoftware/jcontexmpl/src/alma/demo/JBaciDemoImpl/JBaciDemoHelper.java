...
import alma.demo.JBaciDemoPOATie;
import alma.demo.JBaciDemoImpl.JBaciDemoImpl;
 ...
 * <p>
 * Name="JBACIDEMO1" Code="alma.demo.JBaciDemoImpl.JBaciDemoHelper" Type="IDL:alma/demo/JBaciDemo:1.0" Container="frodoContainer"
 * <p>
 * @author alma-component-helper-generator-tool
 */
public class JBaciDemoHelper extends ComponentHelper
{
	/**
	 * Constructor
	 * @param containerLogger logger used only by the parent class.
	 */
	public JBaciDemoHelper(Logger containerLogger)
	{
	...
	*/
	...
	{
		return JBaciDemoOperations.class;
	}
